...
def create_cluster(cluster_name=None,
                   ID=None,
                   nodes_: Set[structure.NodeStruct] = None,
                   relations_: Set[structure.RelationStruct] = None):
    """
    creates a list of nodes from a related collected of nodes using a nodes_

    Arguments:
        nodes_ {structure.NodeStruct} -- any node that is related to the collection of related nodes
    ...
    nodeCluster_ = structure.NodeClusterStruct(
...
def clear_cluster(nodeCluster_: structure.NodeClusterStruct):
    nodeCluster_.nodes=dict()
    nodeCluster_.relations=dict()

def create_relation(nodeCluster_: structure.NodeClusterStruct,
                    relation=None,
                    ID=None
                    ):
    """
    ...
    if ID ==None:
        ...
        _ID = ID
    relation_obj = structure.RelationStruct(
...
def generate_IDs(nodeCluster_: structure.NodeClusterStruct):
    Debug_Tools.debug_msg('NodeCluster generate_IDs started', True)

    def generate_relative(nodeCluster_: structure.NodeClusterStruct):
...
def describe(node_cluster: structure.NodeClusterStruct, to_node_data_keys: list = None, mode: str = None, describer_=print, describer_args: list = None):
