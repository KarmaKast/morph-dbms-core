...
class Node_Manager:
    ...
    def add_relation_claim(from_node: structure.node_structs.Node_Struct, 
        ...
        relations = Node_Manager.add_relation([from_node,to_node], rel_from_to_to, rel_to_to_from)
    ...
    def claim_relations(from_node: structure.node_structs.Node_Struct, 
        ...
        for to_node_ in to_nodes:
            relation_claims = Node_Manager.add_relation_claim(from_node, to_node_, rel_from_to_to, rel_to_to_from)
